...
### PR Review
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\pr_review\SKILL.md
- Trigger: Guidelines and tools for reviewing pull requests in the Angular repository.
- Rules:
...
### accessibility
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\accessibility\SKILL.md
...
### adev-writing-guide
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\adev-writing-guide\SKILL.md
- Trigger: Comprehensive writing guide for Angular documentation (adev). Covers Google Technical Writing standards, Angular-specific markdown extensions, code blocks, and components. You MUST use this skill any time you plan to create, edit, or review documentation files in `adev/` or `adev/src/content`.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### angular-developer
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\angular-developer\SKILL.md
- Trigger: Generates Angular code and provides architectural guidance. Trigger when creating projects, components, or services, or for best practices on reactivity (signals, linkedSignal, resource), forms, dependency injection, routing, SSR, accessibility (ARIA), animations, styling (component styles, Tailwind CSS), testing, or CLI tooling.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: C:\Users\UMBRELLA\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\UMBRELLA\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\UMBRELLA\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\UMBRELLA\.config\opencode\skills\comment-writer\SKILL.md
...
### frontend-design
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\frontend-design\SKILL.md
...
### go-testing
- Path: C:\Users\UMBRELLA\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\UMBRELLA\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\UMBRELLA\.config\opencode\skills\judgment-day\SKILL.md
...
### skill-creator
- Path: C:\Users\UMBRELLA\.config\opencode\skills\skill-creator\SKILL.md
...
- Path: C:\personal_projects\trello-clone\app_trello\.agents\skills\tailwind-css-patterns\SKILL.md
...
### work-unit-commits
- Path: C:\Users\UMBRELLA\.config\opencode\skills\work-unit-commits\SKILL.md
